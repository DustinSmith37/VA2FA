...
function createDownloadLink(blob) {
	...
	if(count == 4){ //currently, once three audios are recorded the page will change
		...
		setTimeout(function() {
                window.location.href="login_index.php"; //wait half a second to change page back to login page, gives audio blob time to transfer. 
            }, 500);
